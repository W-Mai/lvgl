# LVGL Cache Framework Architecture
...
For more detailed information about the implementation and API, refer to the [Implementation Details](implementation_details_en.md) and [API Reference](api_reference_en.md) sections.