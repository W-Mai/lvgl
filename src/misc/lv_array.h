 ...
 * @param array pointer to an `lv_array_t` variable to initialize
 * @param buff pointer to a buffer to use as the array's data
 * @param capacity the initial capacity of the array
 * @param element_size the size of an element in bytes
 */
void lv_array_init_from_buff(lv_array_t * array, void * buff, uint32_t capacity, uint32_t element_size);
